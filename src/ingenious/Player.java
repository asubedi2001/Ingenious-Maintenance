...
public abstract class Player
{
	...
	public boolean checkHand() { // make sure that if the player has a bunch of
									// tied scores for the lower; create second
									// array of all the lowest colors, go
									// through and check for each of those
									// colors in the hand
		...
		for (int count = 0; count < hand.getSize(); count++) {
			for (int a = 0; a < lowestColors.size(); a++) {
				// check to see if the lowest scoring color (lowestColor) is NOT
				// in the hand/rack
